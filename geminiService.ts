...
export async function generateWatercolourPainting(imageDataUrl: string): Promise<string> {
  ...
  // 2. Prepare Prompt
  const prompt = 'Create a highly realistic, detailed traditional watercolor painting from the front of this property. Focus on architectural accuracy, natural lighting, and realistic textures.';
